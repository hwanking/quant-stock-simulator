...
check("문턱을 새로 고르지 않았다 (가드 15% = 구역 판정 1.15배)",
      '_OVER_BLOCK_PCT = 15.0' in _na211
      and _zns211['_zone_of'](114.9, 100.0)[0] != '적정가 크게 초과 (추격매수 위험)'
      and _zns211['_zone_of'](115.1, 100.0)[0] == '적정가 크게 초과 (추격매수 위험)',
      '가드의 15% 와 구역 판정의 1.15 가 같은 자리를 가리켜야 한다')
